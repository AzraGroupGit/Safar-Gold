...
## Corpus Check
- 93 files · ~190,339 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 475 nodes · 802 edges · 31 communities (25 shown, 6 thin omitted)
...
Cohesion: 0.07
Nodes (37): dynamic, GET(), dynamic, GET(), dynamic, GET(), POST(), dynamic (+29 more)
...
Cohesion: 0.09
Nodes (20): dynamic, HomePage(), metadata, CaraTransaksi(), FAQ(), faqs, FeaturableWidget(), GoldDivider() (+12 more)
...
Cohesion: 0.07
Nodes (27): DailySummary, EOD, LaporanClient(), StockRow, dynamic, metadata, dynamic, InvoicePage() (+19 more)
...
Cohesion: 0.13
Nodes (17): AdminHargaPage(), dynamic, dynamic, metadata, OrdersPage(), loadData(), dynamic, KalkulatorPage() (+9 more)
...
Cohesion: 0.13
Nodes (11): AdminDashboard(), loadSettings(), dynamic, AdminPengaturanClient(), AdminPengaturanPage(), dynamic, AdminSkeleton(), getMedianFactors() (+3 more)
...
Cohesion: 0.14
Nodes (15): dynamic, HargaPage(), metadata, LegalNotice(), crosshairPlugin, formatCompact(), formatDateLabel(), formatRupiah() (+7 more)

### Community 32 - "gold-api.ts"
Cohesion: 0.08
Nodes (38): AdminKontenClient(), AdminKontenPage(), dynamic, POST(), DELETE(), dynamic, POST(), dynamic (+30 more)
...
- **Why does `formatRupiah()` connect `OrdersClient.tsx` to `gold-api.ts`, `PriceApprovalPanel`, `(public)/page.tsx`, `getAllGoldTypes`, `admin/page.tsx`, `OrdersClient`, `(public)/harga/page.tsx`?**
