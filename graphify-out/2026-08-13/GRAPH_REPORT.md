...
## Corpus Check
- 90 files · ~94,644 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 381 nodes · 663 edges · 29 communities (22 shown, 7 thin omitted)
...
Cohesion: 0.16
Nodes (17): AdminHargaClient(), formatRupiahClient(), MODE_TABS, ModeModal(), CATEGORY_LABELS, formatRupiah(), PreviewItem, PricePreviewModal() (+9 more)
...
Cohesion: 0.10
Nodes (24): AdminHargaPage(), dynamic, dynamic, metadata, OrdersPage(), AdminDashboard(), dynamic, HargaPage() (+16 more)
