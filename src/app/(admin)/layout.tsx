    ...
    <div className="min-h-screen bg-surface">
      ...
      <div className="lg:ml-64">
        <div className="sticky top-0 z-30 flex items-center gap-3 border-b border-border/60 bg-white px-4 py-3 lg:hidden">
          ...
          <img src="/logo-1.png" alt="Safar Gold" className="h-7 w-auto rounded-lg object-contain" />
          <span className="text-xs font-semibold uppercase tracking-wider text-text-muted">Admin Panel</span>
        </div>
