...
export default async function KunjungiKami() {
  ...
  return (
    <section className="relative overflow-hidden bg-white px-4 py-16 md:px-6 md:py-24 lg:py-32">
      <span className="pointer-events-none absolute -left-8 -top-8 select-none font-serif text-[8rem] font-bold leading-none text-gold/[0.04] md:text-[14rem]">04</span>
          ...
          <div className="flex flex-col justify-center p-6 md:p-8 lg:col-span-2 lg:p-10">
            <div className="space-y-5 md:space-y-6">
              <div className="flex gap-3 md:gap-4">
                ...
                <div>
                  <h4 className="font-serif text-sm font-semibold text-text md:text-base">Alamat</h4>
                  <p className="text-sm text-text-muted">{s.address}</p>
                </div>
              </div>
              <div className="flex gap-3 md:gap-4">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gold/5 text-gold md:h-11 md:w-11">
                ...
                <div>
                  <h4 className="font-serif text-sm font-semibold text-text md:text-base">Jam Operasional</h4>
                  <p className="text-sm text-text-muted">Sen-Jum: {s.weekdayOpen}-{s.weekdayClose}</p>
                  <p className="text-sm text-text-muted">Sabtu: {s.saturdayOpen}-{s.saturdayClose}</p>
                </div>
              </div>
              <div className="flex gap-3 md:gap-4">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gold/5 text-gold md:h-11 md:w-11">
                ...
                <div>
                  <h4 className="font-serif text-sm font-semibold text-text md:text-base">Kontak</h4>
